...
Task 11 Write a script that counts the number of directories and sub-directories in the current directory. While the current and parent directories are not taken into accout, the hidden directories are counted.
